...
# data.pkg.url <- 'doi.org/10.6073/pasta/08abf45e6ef1585ad7ee1e00fb9d7dc1'
# 
# # A typical dataset
# # This data package fails to load in metajam ... error message:
# #
...
# data.pkg.url <- 'https://doi.org/10.6073/pasta/08abf45e6ef1585ad7ee1e00fb9d7dc1'
# 
